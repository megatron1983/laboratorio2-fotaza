      ...
      <section>
         <form action="" method="post" class="registrar">
            ...
            <div class="subgrupo2">
               ...
               <input id="foto" class="input-file" type="file" name="foto" required>
            </div>
            <div class="subgrupo2">
               <label for="titulo">Título</label> 
               <input id="titulo" value="" type="text" name="titulo" minlength="5" class="form-control" required />
            </div>
            <div class="subgrupo2">
               <label for="categoria">Seleccione la categoria</label>
                  <select id="categoria" class="form-select form-control" name="categoria" aria-label="Default select example">
            ...
            <div class="subgrupo2">
               ...
               <input id="fecha" value="" type="date" name="fecha" class="form-control" required />
            </div>
            <div class="subgrupo2">
               <label for="derechos">Tipo de derecho</label>
               <select id="derechos" class="form-select form-control" name="derechos" aria-label="Default select example">
            ...
            <div class="subgrupo2">
               ...
               <input id="etiqueta1" value="" type="text" name="etiqueta1" minlength="5" class="form-control" required />
            </div>
            <div class="subgrupo2">
               <label for="etiqueta2">Etiqueta 2</label> 
               <input id="etiqueta2" value="" type="text" name="etiqueta2" minlength="5" class="form-control" required />
            </div>
            <div class="subgrupo2">
               <label for="etiqueta3">Etiqueta 3</label> 
               <input id="etiqueta3" value="" type="text" name="etiqueta3" minlength="5" class="form-control" required />
            </div>
            <div class="subgrupo2">
